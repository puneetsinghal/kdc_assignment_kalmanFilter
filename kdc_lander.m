...
markersn = data(1:1000,105:128);
save('markersn_ass4','markersn');
marker_coordinates = data(1:2000,81:104);

artifact_centroid = reshape(mean(reshape(marker_coordinates,[],8),2),1000,[]);
...
fid = fopen('./part3/problem_2_0.dat','wt');
...
fid = fopen('./part3/problem_2_1.dat','wt');
...
fid = fopen('./part3/problem_2_2.dat','wt');
